...
public:
  ...
  void
  fileFQ (std::string msgtype, std::string key, std::vector<char> *bufa);
  void
  fileFJ (std::string msgtype, std::string key, std::vector<char> *bufa);
  void
  fileFA (std::string msgtype, std::string key, std::vector<char> *bufa);
  void
  fileFr (std::string msgtype, std::string key, int rcvip6, sockaddr_in6 *from6,
	  sockaddr_in *from, int sockipv4, std::vector<char> *bufa);
  void
  fileFRFI (std::string msgtype, std::string key, std::vector<char> *bufa);
  void
  fileFB (std::string msgtype, std::string key, int rcvip6, sockaddr_in6 *from6,
	  sockaddr_in *from, int sockipv4, std::vector<char> *bufa);
  void
  fileFH (std::string msgtype, std::string key, std::vector<char> *bufa);
  void
  fileFb (std::string msgtype, std::string key, int rcvip6, sockaddr_in6 *from6,
	  sockaddr_in *from, int sockipv4, std::vector<char> *bufa);
  void
  fileFp (std::string msgtype, std::string key, std::vector<char> *bufa);
  void
  fileFe (std::string msgtype, std::string key, std::vector<char> *bufa);
  void
  fileFE (std::string msgtype, std::string key, std::vector<char> *bufa);
  void
  fileFF (std::string msgtype, std::string key, std::vector<char> *bufa);
private:
