...
`Путь к файлу звукового сигнала` - пустая строка - значение по умолчанию. Вы также установить свой вариант звукового сигнал, для этого укажите полный путь к соответствующему файлу и нажмите "Применить".
