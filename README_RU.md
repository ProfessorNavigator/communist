...
Для изменения внешнего вида окна программы отредактируйте файл ../share/Communist/mainWindow.css (см. исходный код и [https://docs.gtk.org/gtk4/css-properties.html](), чтобы узнать детали). Чтобы изменить фон главного окна поместите своё изображение в ../share/Communist/background.jpeg (изображение должно быть в формате jpeg).
